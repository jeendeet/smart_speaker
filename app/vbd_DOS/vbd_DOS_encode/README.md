## Build on armhf
/usr/bin/arm-linux-gnueabihf-g++ encode_wav.cpp -o encode_wav
(build encode with sample rate 44100Hz)
## run on armhf
encode_wav -s<string_encoded> -f<wave_file>

ex: encode_wav -s'ViVi68686868' -fViVi68686868.wav

LD_LIBRARY_PATH=/system/workdir/lib /system/workdir/bin/aplay ViVi68686868.wav
