...
bool LatticeFasterOnlineDecoderBdiTpl<FST>::TestGetBestPath(
...
template <typename FST>
bool LatticeFasterOnlineDecoderBdiTpl<FST>::GetBestPath(Lattice *olat,
                                                     bool use_final_probs) const {
    olat->DeleteStates();
...
template <typename FST>
typename LatticeFasterOnlineDecoderBdiTpl<FST>::BestPathIterator LatticeFasterOnlineDecoderBdiTpl<FST>::BestPathEnd(
...
template <typename FST>
typename LatticeFasterOnlineDecoderBdiTpl<FST>::BestPathIterator LatticeFasterOnlineDecoderBdiTpl<FST>::TraceBackBestPath(
...
template <typename FST>
bool LatticeFasterOnlineDecoderBdiTpl<FST>::GetRawLatticePruned(
        Lattice *ofst,
        bool use_final_probs,
...
template class LatticeFasterOnlineDecoderBdiTpl<fst::Fst<fst::StdArc> >;
template class LatticeFasterOnlineDecoderBdiTpl<fst::VectorFst<fst::StdArc> >;
template class LatticeFasterOnlineDecoderBdiTpl<fst::ConstFst<fst::StdArc> >;
template class LatticeFasterOnlineDecoderBdiTpl<fst::ConstGrammarFst >;
template class LatticeFasterOnlineDecoderBdiTpl<fst::VectorGrammarFst >;
