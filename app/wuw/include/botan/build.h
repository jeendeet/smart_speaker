...
/*
* Build configuration for Botan 2.19.2
*
* Automatically generated from
* 'configure.py --cpu=arm32'
*
* Target
*  - Compiler: arm-linux-gnueabihf-g++ -fstack-protector -pthread -std=c++11 -D_REENTRANT -O3
*  - Arch: arm32
*  - OS: linux
*/
...
#define BOTAN_VERSION_VC_REVISION "git:9a1d25a84242360467ff1351c98b95e5d0d7d6ec"
